...
public class aliDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String accessKeyId = "LTAI5tLi6LHANUb1vZhALB7L";
        String accessKeySecret = "PTGz4G5a9sFPef5sr761kj6v2T0H0e";

        // 填写Bucket名称，例如examplebucket。
        String bucketName = "learn-tlias";
        // 填写Object完整路径，完整路径中不能包含Bucket名称，例如exampledir/exampleobject.txt。
        String objectName = "learn-tlias/aliTest.txt";
